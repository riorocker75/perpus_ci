...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  ...
  <a href="<?php echo base_url().'admin/perusahaan'?>" class="d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Kembali</a>
</div>
		...
		<div class="row">
            <div class="col-lg-12 mb-4">
                <div class="card shadow mb-4">
                    ...
                    <!-- <form action="<?php echo base_url().'admin/perusahaan_update'?>" method="post" enctype='multipart/form-data'> -->
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" name="bidang" value="<?php echo $dt->bidang?>" disabled>
