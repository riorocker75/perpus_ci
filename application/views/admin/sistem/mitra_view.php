		...
		<div class="row">
            <div class="col-lg-12 mb-4">
                <div class="card shadow mb-4">
                    ...
                    <!-- <form action="<?php echo base_url().'admin/mitra_act'?>" method="post" enctype='multipart/form-data'> -->
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" name="pemilik" value="<?php echo $dt->pemilik?>" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" name="email" value="<?php echo $dt->email?>" disabled>
